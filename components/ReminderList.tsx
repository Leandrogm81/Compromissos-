...
const ReminderList: React.FC<ReminderListProps> = ({ reminders, onToggleStatus, onDelete, onEdit, onView, onViewImage, onUpdateSubtaskStatus, onExport }) => {
  return (
